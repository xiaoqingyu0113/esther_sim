...
It renames all the occurrences of fgmp (in files, directories, etc.) to the new project name.
"""
...
if __name__ == "__main__":
    ...
    if proceed.lower() == "y":
        # rename the fgmp folder
        os.rename(
            os.path.join(root_dir_path, "exts", "fgmp", "fgmp"),
            os.path.join(root_dir_path, "exts", "fgmp", new_name),
        )
        os.rename(os.path.join(root_dir_path, "exts", "fgmp"), os.path.join(root_dir_path, "exts", new_name))
